...
export default function Projects() {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                ...
                const response = await axios.get("https://music-gen-demo-omarrx14.replit.app/api/projects", {
    ...
    const handleDelete = async (projectId: number) => {
        try {
            const token = localStorage.getItem("token");
            await axios.delete(`https://music-gen-demo-omarrx14.replit.app/api/projects/${projectId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
